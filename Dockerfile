...
COPY --from=frontend-build /app/src/archiefvernietingscomponent/static /app/src/archiefvernietingscomponent/static
...
ENV DJANGO_SETTINGS_MODULE=archiefvernietingscomponent.conf.docker
