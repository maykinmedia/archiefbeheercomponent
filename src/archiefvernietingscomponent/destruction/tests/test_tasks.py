...
@patch("archiefvernietingscomponent.destruction.tasks.chain")
@patch("archiefvernietingscomponent.destruction.tasks.complete_and_notify")
@patch("archiefvernietingscomponent.destruction.tasks.process_list_item")
...
class ProcessListItemTests(TestCase):
    @patch("archiefvernietingscomponent.destruction.tasks.remove_zaak")
    @patch(
        "archiefvernietingscomponent.destruction.tasks.fetch_zaak",
    ...
    @patch(
        "archiefvernietingscomponent.destruction.tasks.remove_zaak",
    ...
    @patch("archiefvernietingscomponent.destruction.tasks.remove_zaak")
    @patch("archiefvernietingscomponent.destruction.tasks.fetch_zaak")
...
@patch(
    "archiefvernietingscomponent.destruction.tasks.update_zaak_from_list_item.chunks"
)
...
class UpdateZaakTests(TestCase):
    @patch(
        "archiefvernietingscomponent.destruction.tasks.update_zaak",
        return_value={"identificatie": "foobar"},
    )
